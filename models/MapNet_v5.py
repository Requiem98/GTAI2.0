...
class MapNet_v5(nn.Module):
    ...
    def __init__(self, device):
        ...
        self.linear_1 = nn.Linear(42496, 2048)
        self.relu_1 = nn.ReLU()
        self.batchNorm_linear_1 = nn.BatchNorm1d(2048)
        
        
        self.linear_2 = nn.Linear(2048, 512)
        self.relu_2 = nn.ReLU()
        self.batchNorm_linear_2 = nn.BatchNorm1d(512)
        
        self.linear_3 = nn.Linear(512, 256)
        self.relu_3 = nn.ReLU()
        self.batchNorm_linear_3 = nn.BatchNorm1d(256)
        
        
        self.linear_4 = nn.Linear(256, 64)
        self.relu_4 = nn.ReLU()
        self.batchNorm_linear_4 = nn.BatchNorm1d(64)
        
        self.linear_5 = nn.Linear(64, 32)
        self.relu_5 = nn.ReLU()
        self.batchNorm_linear_5 = nn.BatchNorm1d(32)

        
        
        
        self.linear_6 = nn.Linear(27521, 2048)
        self.relu_6 = nn.ReLU()
        self.batchNorm_linear_6 = nn.BatchNorm1d(2048)
        
        
        self.linear_7 = nn.Linear(2048, 512)
        self.relu_7 = nn.ReLU()
        self.batchNorm_linear_7 = nn.BatchNorm1d(512)
        
        self.linear_8 = nn.Linear(512, 256)
        self.relu_8 = nn.ReLU()
        self.batchNorm_linear_8 = nn.BatchNorm1d(256)
        
        
        self.linear_9 = nn.Linear(256, 64)
        self.relu_9 = nn.ReLU()
        self.batchNorm_linear_9 = nn.BatchNorm1d(64)
        
        self.linear_10 = nn.Linear(64, 32)
        self.relu_10 = nn.ReLU()
        self.batchNorm_linear_10 = nn.BatchNorm1d(32)


        self.linear_11 = nn.Linear(32, 1) #steering angle
        self.linear_12 = nn.Linear(32, 2) #acceleration, brake
    ...
    def forward(self, x_img, x_mmap, x_speed):
        ...
        x_steering = self.batchNorm_linear_1(self.relu_1(self.linear_1(x_steering)))
        x_steering = self.batchNorm_linear_2(self.relu_2(self.linear_2(x_steering)))
        x_steering = self.batchNorm_linear_3(self.relu_3(self.linear_3(x_steering)))
        x_steering = self.batchNorm_linear_4(self.relu_4(self.linear_4(x_steering)))
        x_steering = self.batchNorm_linear_5(self.relu_5(self.linear_5(x_steering)))
        
        x_steering = self.linear_11(x_steering)
        
        
        
        
        x_acc_brk = torch.cat([x_img, x_speed.unsqueeze(1)], 1)
        
        x_acc_brk = self.batchNorm_linear_6(self.relu_6(self.linear_6(x_acc_brk)))
        x_acc_brk = self.batchNorm_linear_7(self.relu_7(self.linear_7(x_acc_brk)))
        x_acc_brk = self.batchNorm_linear_8(self.relu_8(self.linear_8(x_acc_brk)))
        x_acc_brk = self.batchNorm_linear_9(self.relu_9(self.linear_9(x_acc_brk)))
        x_acc_brk = self.batchNorm_linear_10(self.relu_10(self.linear_10(x_acc_brk)))
        
        x_acc_brk = self.linear_12(x_acc_brk)
