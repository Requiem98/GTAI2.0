...
if __name__ == '__main__':
    ...
    CKP_DIR = "./Data/models/MapNet_v4/checkpoint/"
    SCORE_DIR = "./Data/models/MapNet_v4/scores/"
    ...
    model = MapNet_v4(device = device).to(device) #qui inserire modello da trainare
...
#== Best Result ==
#Total Test Loss:  0.0443 --- MAE SA:  0.0402 --- MAE Acc:  0.1582 --- MAE brk:  0.0137
