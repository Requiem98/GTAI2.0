...
if __name__ == '__main__':
    ...
    CKP_DIR = "./Data/models/MapNet_v7/checkpoint/"
    SCORE_DIR = "./Data/models/MapNet_v7/scores/"
    ...
    model = MapNet_v7(device = device).to(device) #qui inserire modello da trainare
    model.load_state_dict(torch.load(CKP_DIR+ "00030.pth"))
...
#Total Train Loss: 0.0028642411 --- MAE SA: 0.030203 --- MAE Acc: 0.127216 --- Recall brk: 0.950912 # epoch 50

#== Best Result ==
#Total Test Loss: 0.0386173502 --- MAE SA: 0.041207 --- MAE Acc: 0.176765 --- Recall brk: 0.356111 # epoch 50
